...
def load_trained_model(weight_fname, map_location="cpu"):
    try:
        ...
        return ModelTrainer.load_from_checkpoint(
            weight_fname, map_location=map_location
        ).net
...
def visualise_model_pred(
    ...
    **kwargs,
    ...
    query_pt, prob = get_grid_points(model, **kwargs)
